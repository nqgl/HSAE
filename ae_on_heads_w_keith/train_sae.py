...
cfg = z_sae.AutoEncoderConfig(site="resid_post", act_size=512, layer=1, gram_shmidt_trail = 512, num_to_resample = 64,
                                l1_coeff=6e-3, dict_mult=16, batch_size=512, beta2=0.99,
