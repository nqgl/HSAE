...
ae_cfg = z_sae.AutoEncoderConfig(site="resid-pre", act_size=512, layer=1, gram_shmidt_trail = 512, num_to_resample = 64,
                                l1_coeff=30e-4, dict_mult=8, batch_size=128, beta2=0.99, l1_embed_coeff_divisor = 1,
