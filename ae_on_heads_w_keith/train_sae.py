...
cfg = z_sae.AutoEncoderConfig(site="mlp_pre", act_size=512, layer=1, gram_shmidt_trail = 512, num_to_resample = 64,
                                l1_coeff=3e-4, dict_mult=16, batch_size=512, beta2=0.99, data_rescale=1/128,
