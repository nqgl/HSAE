...
ae_cfg = z_sae.AutoEncoderConfig(site="z", act_size=512, layer=1, gram_shmidt_trail = 500, num_to_resample = 64,
                                l1_coeff=42e-4, dict_mult=16, batch_size=256, beta2=0.99,
