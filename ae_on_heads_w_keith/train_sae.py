...
def main():
    ...
    ae_cfg = z_sae.AutoEncoderConfig(site="z", act_size=512, 
                                    l1_coeff=70e-4, dict_mult=256, batch_size=128,
                                    nonlinearity=("undying_relu", {"l" : 0.00005, "k" : 1, "leaky" : True}), flatten_heads=True,
                                    lr=2e-5, cosine_l1={"period" : 3500, "range" : 0.3}) #original 3e-4 8e-4 or same but 1e-3 on l1
