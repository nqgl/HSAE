...
cfg = HierarchicalAutoEncoderConfig(site="resid_pre", d_data=64, layer=1, gram_shmidt_trail = 512, num_to_resample = 4,
                                l1_coeff=5e-3, dict_mult=2, batch_size=8, beta2=0.999,
