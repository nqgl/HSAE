...
def train(encoder :HierarchicalAutoEncoder, cfg :HierarchicalAutoEncoderConfig, buffer :ToyModel):
    ...
    try:
        ...
        for i in tqdm.trange(num_batches):
            ...
            if False and i % 200 == 99 and encoder.neurons_to_be_reset is not None:
...
cfg = HierarchicalAutoEncoderConfig(site="resid_pre", d_data=256, layer=1, gram_shmidt_trail = 512, num_to_resample = 4,
                                l1_coeff=5e-3, dict_mult=4, batch_size=16, beta2=0.999,
