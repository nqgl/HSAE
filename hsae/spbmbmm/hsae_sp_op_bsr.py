...
def bsr_hsae_spop(
    ...
    gate_rest = gate_rest.to_sparse_bsr((16, 16))
...
def main():
    ...
    b_dec = o.b_dec
    W_dec = o.W_dec
    bsr_hsae_spop(x, gate, W_enc, b_enc, W_dec, b_dec, None, None)
    # exit()
    test_sparse_forward_validity(bsr_hsae_spop, caching=False)
    test_speed(bsr_hsae_spop)
